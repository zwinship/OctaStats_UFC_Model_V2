...
def assign_fighting_styles(df, career_df):
    ...
    def classify_style(row):
        ...
        # Score each style by what fraction of its criteria the fighter meets.
        # Highest-scoring eligible style wins; ties broken by priority order.
        scores = {}
...
def train_dynamic_logit(matchup_df):
    ...
    cv_auc = cross_val_score(
        ...
        scoring="roc_auc",
        fit_params={"lasso_logit__sample_weight": sample_weights},
    ).mean()
